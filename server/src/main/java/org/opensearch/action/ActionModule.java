...
import org.opensearch.action.admin.indices.split.TransportInPlaceShardSplitAction;
...
import org.opensearch.rest.action.admin.indices.RestInPlaceShardSplitHandler;
...
public class ActionModule extends AbstractModule {
    ...
    static Map<String, ActionHandler<?, ?>> setupActions(List<ActionPlugin> actionPlugins) {
        ...
        actions.register(InPlaceShardSplitAction.INSTANCE, TransportInPlaceShardSplitAction.class);
    ...
    public void initRestHandlers(Supplier<DiscoveryNodes> nodesInCluster) {
        ...
        registerHandler.accept(new RestInPlaceShardSplitHandler());
