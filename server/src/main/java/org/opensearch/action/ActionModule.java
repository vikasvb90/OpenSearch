...
import org.opensearch.action.admin.indices.forcemerge.TransportShardExpungeDeletesAction;
...
import org.opensearch.rest.action.admin.indices.RestForceExpungeDeleteShardAction;
...
public class ActionModule extends AbstractModule {
    ...
    static Map<String, ActionHandler<?, ?>> setupActions(List<ActionPlugin> actionPlugins) {
        ...
        actions.register(ForceExpungeDeletesShardAction.INSTANCE, TransportShardExpungeDeletesAction.class);
    ...
    public void initRestHandlers(Supplier<DiscoveryNodes> nodesInCluster) {
        ...
        registerHandler.accept(new RestForceExpungeDeleteShardAction());
