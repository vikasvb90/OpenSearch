...
import org.opensearch.action.admin.indices.localsplit.TransportLocalShardSplitAction;
...
import org.opensearch.rest.action.admin.indices.RestLocalShardSplitHandler;
...
public class ActionModule extends AbstractModule {
    ...
    static Map<String, ActionHandler<?, ?>> setupActions(List<ActionPlugin> actionPlugins) {
        ...
        actions.register(LocalShardSplitAction.INSTANCE, TransportLocalShardSplitAction.class);
    ...
    public void initRestHandlers(Supplier<DiscoveryNodes> nodesInCluster) {
        ...
        registerHandler.accept(new RestLocalShardSplitHandler());
