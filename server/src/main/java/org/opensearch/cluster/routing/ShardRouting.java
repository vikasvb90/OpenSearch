...
public class ShardRouting implements Writeable, ToXContentObject {
    ...
    protected ShardRouting(
        ...
        assert recoverySource == null || recoverySource == PeerRecoverySource.INSTANCE || primary || searchOnly ||
            recoverySource == RecoverySource.InPlaceShardSplitRecoverySource.INSTANCE
    ...
    public boolean isStartedChildReplica() {
        return isChildReplica() && started();
    }

    public boolean isChildReplica() {
        return primary == false && getParentShardId() != null;
    }
}
